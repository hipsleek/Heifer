...
and retype_staged_spec (staged_spec : Hiptypes.staged_spec) : staged_spec =
  ...
  | Hiptypes.Bind (v, s1, s2) -> Bind (v, retype_staged_spec s1, retype_staged_spec s2)
  ...
  | Hiptypes.Shift (b, k, body, x, cont) -> Shift (b, k, retype_staged_spec body, binder_of_ident x, retype_staged_spec cont)
