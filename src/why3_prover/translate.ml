...
let rec term_to_whyml_aux ctxt t =
  ...
  | Binop (Plus, a, b) ->
    ...
    tapp (qualid ["plus"]) [term_to_whyml_aux ctxt a; term_to_whyml_aux ctxt b]
  | Binop (Cons, h, t) ->
  ...
  | Binop (Neq, a, b) ->
    tapp (qualid ["PNeq"]) [term_to_whyml_aux ctxt a; term_to_whyml_aux ctxt b]
    (* | PAtom _ ->
  ...
  | Conj (a, b) ->
    tapp (qualid ["PAnd"]) [term_to_whyml_aux ctxt a; term_to_whyml_aux ctxt b]
  | Disj (a, b) ->
